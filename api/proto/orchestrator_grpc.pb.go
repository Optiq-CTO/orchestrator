...
type OrchestratorServiceClient interface {
	RunPipeline(ctx context.Context, in *PipelineRequest, opts ...grpc.CallOption) (*PipelineResponse, error)
}
...
func (c *orchestratorServiceClient) RunPipeline(ctx context.Context, in *PipelineRequest, opts ...grpc.CallOption) (*PipelineResponse, error) {
	out := new(PipelineResponse)
	err := c.cc.Invoke(ctx, "/orchestrator.OrchestratorService/RunPipeline", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrchestratorServiceServer interface {
	RunPipeline(context.Context, *PipelineRequest) (*PipelineResponse, error)
...
func (UnimplementedOrchestratorServiceServer) RunPipeline(context.Context, *PipelineRequest) (*PipelineResponse, error) {
...
func _OrchestratorService_RunPipeline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PipelineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrchestratorServiceServer).RunPipeline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orchestrator.OrchestratorService/RunPipeline",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrchestratorServiceServer).RunPipeline(ctx, req.(*PipelineRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrchestratorService_RunPipeline_Handler,
		},
	},
