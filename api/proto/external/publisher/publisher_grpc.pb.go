...
type PublisherServiceClient interface {
	PublishContent(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error)
}
...
func (c *publisherServiceClient) PublishContent(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	out := new(PublishResponse)
	err := c.cc.Invoke(ctx, "/publisher.PublisherService/PublishContent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PublisherServiceServer interface {
	PublishContent(context.Context, *PublishRequest) (*PublishResponse, error)
...
func (UnimplementedPublisherServiceServer) PublishContent(context.Context, *PublishRequest) (*PublishResponse, error) {
...
func _PublisherService_PublishContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PublisherServiceServer).PublishContent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/publisher.PublisherService/PublishContent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublisherServiceServer).PublishContent(ctx, req.(*PublishRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PublisherService_PublishContent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/external/publisher/publisher.proto",
}
